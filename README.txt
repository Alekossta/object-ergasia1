...
- Δεδομένα που αποθηκεύονται: μαθήματα, μαθητές, καθηγητές, ποιά μαθήματα έχει ο κάθε καθηγητής, ποια μαθήματα έχει ΠΕΡΑΣΕΙ ο κάθε μαθητής, τρέχον έτος, τρέχον εξάμηνο
- Δεδομένα που ΔΕΝ αποθηκεύονται: βαθμοί εξαμήνου
- Επιλογή [x] : εκτυπώνονται όλοι οι καθηγητές, οι μαθητές και τα μαθήματα του τρέχον εξαμήνου
